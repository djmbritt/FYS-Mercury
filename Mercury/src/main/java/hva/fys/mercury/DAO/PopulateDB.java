...
public class PopulateDB {
    ...
    public static void insertBagage() {
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201623700, 'AYT', '17-Jun-2016', '19:25', 'Box', '', '', '1153481443', '', 'Cream', '', '', '', 'P. Curie, Versaille', '', 'Verloren')");
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201625439, 'AYT', '7-Sep-2016', '10:04', 'Suitcase', 'Perry Mackin', '', '1297047756', 'departure hall', 'Bluegreen', 'Violet', '80x60x40', '', 'R. Hauer, Bussum', 'holywood sticker', 'Gevonden')");
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201623923, 'AYT', '4-Jul-2016', '20:05', 'Business Case', 'Eastsport', 'CAI020', '1321391290', 'belt-05', 'Pink', 'Darkbrown', '', '', 'M. Verstappen, Monaco', 'red-bull sticker', 'Gevonden')");
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201626269, 'AYT', '9-Sep-2016', '13:18', 'Sports Bag', 'Baggallini', 'CAI724', '1557534916', 'belt-05', 'Olive', 'Darkred', '60x30x30', '15kg', 'S. Appelmans, De Panne', '', 'Gevonden')");
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201622445, 'AYT', '25-Nov-2015', '12:00', 'Bag', 'Baggallini', 'CAI1828', '1688722916', 'belt-04', 'Black', 'Blue', '60x30x30', '15kg', 'A. van Buren, Wassenaar', 'Orange stripes', 'Verloren')");
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201627004, 'AYT', '10-Sep-2016', '16:30', 'Suitcase', 'Ivy', '', '1957629307', 'arrival hall', 'Orange', '', '70x50x20', '', 'D. Kuyt, Rotterdam', '', 'Gevonden')");
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201626092, 'AYT', '9-Sep-2016', '11:56', 'Suitcase', 'Nautica', '', '1963627893', 'arrival hall', 'Yellow', 'Lightgreen', '80x60x30', '20kg', 'C. van Houten, Naarden', 'many scratches', 'Gevonden')");
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201622309, 'AYT', '20-Oct-2015', '11:50', 'Business Case', 'Ivy', 'TK2414', '2771896151', 'belt-06', 'Blue', '', '50x40x15', '10kg', 'M. Messi, Barcelona', '', 'Gevonden')");
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201625766, 'AYT', '8-Sep-2016', '11:29', 'Box', '', 'HV799', '2973839061', 'belt-06', 'Violet', '', '60x40x30', '15kg', 'N. Bonaparte, Paris', 'chain lock', 'Gevonden')");
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201624729, 'AYT', '23-Aug-2016', '7:30', 'Suitcase', 'Travel Gear', '', '3217712035', '', 'Lightbrown', 'Yellow', '100x60x40', '30kg', 'M. van Basten, Alkmaar', 'ajax stickers', 'Gevonden')");
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201622909, 'AYT', '13-Mar-2016', '19:23', 'Bagpack', 'Hedgren', 'TK2430', '3260024106', 'belt-05', 'Red', 'Cream', '', '', 'F. van der Elst, Brussel', 'football stickers', 'Gevonden')");
        ...
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201622713, 'AYT', '17-Jan-2016', '14:13', 'Suitcase', 'Glove It', 'CAI724', '3794786696', 'belt-01', 'Violet', 'White', '80x60x30', '15kg', 'R. van Persie, Rotterdam', '', 'Gevonden')");
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201625293, 'AYT', '4-Sep-2016', '9:40', 'Business Case', 'Glove It', 'CAI1828', '4497537549', 'belt-06', 'Purple', '', '50x40x15', '10kg', 'M. Rutte, den Haag', '', 'Gevonden')");
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201624845, 'AYT', '24-Aug-2016', '8:10', 'Bag', 'Fjallraven', 'HV649', '4811246270', 'belt-03', 'Gray', '', '50x40x15', '10kg', 'W.A. van Buren, Wassenaar', 'Orange stripes', 'Gevonden')");
        ...
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201624544, 'AYT', '11-Aug-2016', '23:00', 'Business Case', 'Baggallini', 'CAI040', '5877130095', 'belt-06', 'Darkblue', '', '', '', 'J. Verstappen, Oss', 'red-bull sticker', 'Verloren')");
        ...
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201624133, 'AYT', '15-Jul-2016', '20:35', 'Suitcase', 'Everest', 'TK2430', '5955243509', 'belt-01', 'Lightblue', '', '60x40x20', '15kg', 'A. Gerritse, Ilpendam', '', 'Gevonden')");
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201624422, 'AYT', '6-Aug-2016', '22:15', 'Sports Bag', 'Samsonite', '', '6175011250', 'toilet', 'Darkbrown', '', '', '', 'D. de Munck, Amsterdam', '', 'Gevonden')");
        ...
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201626923, 'AYT', '10-Sep-2016', '16:00', 'Business Case', 'Everest', 'CAI806', '6377992003', 'belt-06', 'Lightblue', 'Pink', '50x40x15', '10kg', 'R. de Boer, Southhampton', '', 'Verloren')");
        ...
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201623561, 'AYT', '24-May-2016', '18:44', 'Suitcase', 'Hedgren', 'CAI806', '7620963089', 'belt-04', 'Cream', '', '70x50x20', '10kg', 'S. Kramer, Heerenveen', '', 'Gevonden')");
        ...
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201623033, 'AYT', '13-Apr-2016', '17:17', 'Bag', 'Delsey', 'CAI524', '7975308223', 'belt-01', 'Blue', 'Black', '', '', 'I. de Bruijn, Leiden', 'Olympic rings', 'Gevonden')");
        ...
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201625559, 'AYT', '7-Sep-2016', '10:13', 'Bag', 'Eastsport', 'CAI724', '', 'belt-03', 'Darkgray', 'Olive', '50x40x15', '', 'M. van Buren, Wassenaar', 'Orange stripes', 'Verloren')");
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201625897, 'AYT', '8-Sep-2016', '11:43', 'Sports Bag', 'Eastsport', 'CAI040', '', 'belt-04', 'White', '', '60x30x30', '10kg', 'E. Gruyaert, Antwerpen', '', 'Gevonden')");
        ...
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201626139, 'AYT', '9-Sep-2016', '12:01', 'Bagpack', 'Nautica', '', '', 'arrival hall', 'Olive', 'Orange', '60x30x30', '', 'Mw. Hollande, Paris', '', 'Gevonden')");
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201622587, 'AYT', '25-Dec-2015', '12:04', 'Box', '', 'TK2430', '', 'belt-03', 'Lightgray', 'Red', '60x40x30', '', 'G. dEsting, Paris', '', 'Gevonden')");
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201626397, 'AYT', '9-Sep-2016', '13:21', 'Business Case', 'Hedgren', 'CAI020', '', 'belt-03', 'Brown', '', '50x40x15', '10kg', 'F. de Boer, Amsterdam', 'ajax stickers', 'Verloren')");
        ...
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201626638, 'AYT', '10-Sep-2016', '15:31', 'Bagpack', 'Glove It', 'CAI040', '', 'belt-02', 'Bluegreen', 'Lightblue', '60x30x30', '10kg', 'Mw. Zoetemelk, Lyon', '', 'Verloren')");
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201626755, 'AYT', '10-Sep-2016', '15:40', 'Box', '', '', '', 'toilet', 'Darkgray', 'Darkblue', '', '', 'F. Mitterand, Paris', 'frech national flag sticker', 'Verloren')");
        ...
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201623177, 'AYT', '27-Apr-2016', '17:34', 'Bagpack', 'Ivy', '', '', 'arrival hall', 'Red', 'Darkgray', '', '', 'L.. Van Moortsel, Breda', '', 'Verloren')");
        ...
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201622638, 'AYT', '25-Dec-2015', '18:09', 'Sports Bag', 'Delsey', 'CAI1828', '', 'belt-02', 'Green', 'Brown', '', '', 'E. Leyers, Turnhout', '', 'Verloren')");
        ...
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201623632, 'AYT', '4-Jun-2016', '19:20', 'Bag', 'Briggs', 'TK2414', '', 'belt-04', 'Yellow', '', '', '', 'P. van den Hoogenband, Eindhoven', 'Olympic rings', 'Gevonden')");
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201624064, 'AYT', '9-Jul-2016', '20:18', 'Case', '', '', '', 'arrival hall', 'Darkred', '', '70x50x20', '10kg', 'E. de Munck, Brugge', '', 'Gevonden')");
        myJDBC.executeUpdateQuery("INSERT INTO Bagage VALUES(201624665, 'AYT', '17-Aug-2016', '21:45', 'Bagpack', 'Everest', 'TK2414', '', 'belt-02', 'Darkgreen', '', '', '', 'F. van der Sande, Wuustwezel', '', 'Gevonden')");
    }
